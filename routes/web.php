...
use App\Http\Controllers\Mahasiswa\AssesmenMahasiswaController;
...
Route::group(['middleware' => 'auth', 'PreventBackHistory'], function () {
    ...
    Route::middleware(['assesor'])->group(function () {
        ...
        // assesmens
        Route::resource('assesmen', AssesmenController::class)->except(['show']);
    });
    ...
    Route::middleware(['mahasiswa'])->group(function () {
        ...
        Route::get('/assesmen/mahasiswa', [AssesmenMahasiswaController::class, 'index'])->name('mahasiswa.assesmen.index');
    });
});
